...
@Component
public class BookDeletionByName implements BookDeletionMethod {
    ...
    public String deleteBooks(DeleteBooksRequest deleteBooksRequest) {
        List<BookStore> bookStoreList = bookStoreRespository.findByBookNameIn(deleteBooksRequest.bookNamesList());
